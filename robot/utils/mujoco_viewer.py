...
from robot.utils.mujoco_render_context import MjRenderContextWindow
...
class MujocoROSViewerBasic(MjRenderContextWindow):
    """
...
class MujocoROSViewer(MujocoROSViewerBasic):
    """
