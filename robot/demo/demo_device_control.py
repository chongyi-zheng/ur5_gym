...
if __name__ == "__main__":
    ...
    env = suite.make(
        **config,
        ...
        render_camera="sideview",  # "agentview"
        ignore_done=True,
    ...
    while True:
        ...
        while True:
            ...
            # action = np.array([0.000, 0.000, 0.000, -0.000, 0, 11.250, -1.000])
            last_eef_pos = obs['robot0_eef_quat']
            obs, reward, done, info = env.step(action)
            new_eef_pos = obs['robot0_eef_quat']
            ori_diff = orientation_error(T.quat2mat(new_eef_pos), T.quat2mat(last_eef_pos))
